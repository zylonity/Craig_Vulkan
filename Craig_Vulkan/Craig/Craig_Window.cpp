...
CraigError Craig::Window::init() {
	...
	mp_SDL_Window = SDL_CreateWindow(kSDL_WindowName, SDL_WINDOWPOS_CENTERED,
		SDL_WINDOWPOS_CENTERED, kSDL_WindowWidth, kSDL_WindowHeight, SDL_WINDOW_VULKAN | SDL_WINDOW_RESIZABLE ); //TODO: FIX IMGUIZMO AND HIGHDPI FOR MAC | SDL_WINDOW_ALLOW_HIGHDPI);
